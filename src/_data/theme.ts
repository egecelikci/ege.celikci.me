...
export const components = {
  ...
  tag: {
    base:
      "inline-flex items-center justify-center px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest rounded-md transition-colors duration-200 border border-border",
    default:
      "bg-surface text-text-muted hover:text-primary hover:border-primary",
