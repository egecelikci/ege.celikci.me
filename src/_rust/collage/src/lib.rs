...
pub fn render_background(
    ...
    for y in 0..height {
        ...
        for x in 0..width {
            ...
            let r = lerp(
                lerp(c_tl.0, c_tr.0, c_weight),
                lerp(c_bl.0, c_br.0, c_weight),
                r_weight,
            );
            let g = lerp(
                lerp(c_tl.1, c_tr.1, c_weight),
                lerp(c_bl.1, c_br.1, c_weight),
                r_weight,
            );
            let b = lerp(
                lerp(c_tl.2, c_tr.2, c_weight),
                lerp(c_bl.2, c_br.2, c_weight),
                r_weight,
            );
