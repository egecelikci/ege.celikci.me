  ...
  const stream = new ReadableStream({
    async start(controller) {
      try {
        ...
        // Note: With streaming, we cannot change the status code to 204
        // after the stream has started. If absolutely nothing was found,
        // the body will simply be empty (Content-Length: 0).
      } catch (e) {
